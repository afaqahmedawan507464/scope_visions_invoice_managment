                                    ...
                                    <tr>
                                        @if (\DB::table('attendance_employees')->where('id', '=', $selectEmployeess->id)->whereNotNull('clockOutDate')->count() > 0)
                                            <td style="text-align:center;width: 120px;">
                                                <div class="d-flex justify-content-center align-items-center" style="width: 120px;">{{ \Carbon\Carbon::parse($selectEmployeess->clockInDate)->format('M d, Y') }}</div>
                                            </td>
                                            <td style="text-align:center;width: 200px;">
                                                <div class="d-flex justify-content-center align-items-center" style="width: 200px;">{{ $selectEmployeess->employeename }}</div>
                                                    

                                            </td>
                                            <td style="text-align:center;width: 120px;">
                                                <div class="d-flex justify-content-center align-items-center" style="width: 120px;">{{ \Carbon\Carbon::parse($selectEmployeess->clockInTime)->format('h:i A') }}</div>
                                            ...
                                            <td style="text-align:center;width: 120px;">
                                                ...
                                                @else
                                                <div class="d-flex justify-content-center align-items-center" style="width: 120px;">{{ \Carbon\Carbon::parse($selectEmployeess->clockOutTime)->format('h:i A') }}</div>
                                                        
                                                @endif
                                            </td>
                                            <td style="text-align:center;width: 120px;">
                                                
                                                    <div class="d-flex justify-content-center align-items-center" style="width: 120px;">{{ $selectEmployeess->lateTime }}</div>
