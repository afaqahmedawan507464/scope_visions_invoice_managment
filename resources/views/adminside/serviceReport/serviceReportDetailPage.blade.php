                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="row px-3 pb-2">
                                    <div class="col-12 col-md-5 d-flex justify-content-start align-items-center" style="border:1px solid gray">
                                    ...
                                    <div class="col-12 col-md-4 d-flex justify-content-start align-items-center" style="border:1px solid gray">
                                        <div class="col-6 d-flex justify-content-start align-items-center">
                                            <b class="me-2" style="text-align: end;;font-size:13px;">
                                               Model:
                                            </b>
                                    ...
                                    <div class="col-12 col-md-3 d-flex justify-content-start align-items-center" style="border:1px solid gray">
                                        <div class="col-6 d-flex justify-content-start align-items-center">
                                            <b class="me-2" style="text-align: end;;font-size:13px;">
                                                Sr No:
                                            </b>
                            ...
                            <div class="col-12">
                                ...
                                <div style="overflow-x:auto;">
                                    <table class="w-100">
                                        <thead>
                                            <tr>
                                               <th class="py-1 mb-2" style="text-align:center;border-top: 2px solid black;border-bottom: 2px solid black;"><div class="d-flex justify-content-center align-items-center"><p style="width:50px;font-size: 16px;">Sr no</p></div></th>
                                               <th class="py-1 mb-2" style="text-align:center;border-top: 2px solid black;border-bottom: 2px solid black;"><div class="d-flex justify-content-center align-items-center"><p style="width:350px;font-size: 16px;">Question</p></div></th>
                                               <th class="py-1 mb-2" style="text-align:center;border-top: 2px solid black;border-bottom: 2px solid black;"><div class="d-flex justify-content-center align-items-center"><p style="width:50px;font-size: 16px;">Answer</p></div></th>
                                            </tr>
                                        </thead>
                                        <tbody >
                                            @php
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex justify-content-center align-items-center">
                                                        <p class="text-center" style="width:50px;font-size: 16px;"><span>{{ $service_report_item_srNumbers }}</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex justify-content-center align-items-center">
                                                        <p class="text-center" style="width:350px;font-size: 16px;"><span>{{ $service_report_item_question[$key] }}</span></p>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex justify-content-center align-items-center">
