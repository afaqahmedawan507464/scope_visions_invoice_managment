                    ...
                    <div class="col-12 px-2">
                        <div class="row">
                           ...
                           <div class="col-6 d-flex flex-column justify-content-end align-items-center">
                            ...
                            {{-- <div class="d-md-none d-flex justify-content-end align-items-start w-100">
                                <b style="text-align: start; width:120px;" class="me-2">
                                   Serial No:
                                </b>
                                <span style="width: 75%;">{{ $selectQuotations->id }}</span>
                            </div> --}}
                            <div class="d-flex justify-content-end align-items-start w-100">
                                <b class="me-2" style="text-align: end;width:100px;">
                                   Date:
                             ...
                             {{-- <div class="d-md-none d-flex justify-content-end align-items-start w-100">
                                ...
                                <span style="width: 75%;">{{ \Carbon\Carbon::parse($selectQuotations->delivery_challan_date)->format('M d, Y') }}</span>
                             </div> --}}
                             <div class="d-flex justify-content-end align-items-start w-100">
                                <b class="me-2" style="text-align: end;width:100px;">
                                   Inv No:
                            ...
                            {{-- <div class="d-flex justify-content-end align-items-start w-100 d-md-none">
                                <b style="text-align: start; width:120px;" class="me-2">
                                   Inv No:
                                </b>
                                <span style="width: 75%;">{{ $selectQuotations->invoice_id }}</span>
                            </div> --}}
                           </div>
                        </div>
                        <div class="row">
